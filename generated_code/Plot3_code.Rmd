...
x = seq(0,10)
saveGIF_simple(for (moving_x in seq(-3.5,3.5,length.out = 80)) {
  x = seq(-3.5,3.5,0.1)
  y = dnorm(x,mean = 0,sd = 1)
  plot2_data_in_loop = as.data.frame(cbind(x, y))
  text = paste0('$\\Z =  \\frac{',round_simple(moving_x,2),' -  0}{1}$ = ', round_simple(moving_x,2))
  ...
  plot_ = plot2_data_in_loop %>% 
    ...
    annotate(geom = 'text',x = moving_x, y = 0.42, label = moving_text)
    lims(y = c(0,0.5))
